...
public class KeywordsContentBuilder
{
  ...
  public static ResultSet doSelectQuery(SelectCommand selectCommand, Document requestXml)
  ...
  public static String getLocalKeywordsVersion(Document requestXml)
  {
    ...
    if (("http://schemas.applab.org/2010/07/search".equals(rootElement.getNamespaceURI())) && ("GetKeywordsRequest".equals(rootElement.getLocalName()))) {
