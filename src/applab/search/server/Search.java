...
public class Search extends ApplabServlet {
    ...
    protected void doApplabPost(HttpServletRequest request, HttpServletResponse response, ServletRequestContext context) throws Exception {
        ...
        if ((keyword == null) || (intervieweeId == null) || (location == null) || (submissionTime == null)) {
            ...
            logSearchRequest(context.getHandsetId(), intervieweeId, keyword, content, location, isCachedQuery, submissionTime,
                    context.getSubmissionLocation(), category);
        }
        context.close();
    }

    public static void logSearchRequest(String handsetId, String intervieweeId, String keyword, HashMap<String, String> contentHash,
                                        String location, Boolean isCachedQuery, String submissionTime, String submissionLocation,
                                        String category) throws SQLException, RemoteException, ServiceException {
        String content = null;
        if (isCachedQuery.booleanValue()) {
    ...
    private static void writeResponse(HashMap<String, String> content, ServletRequestContext context) throws IOException,
