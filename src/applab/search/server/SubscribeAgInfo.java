...
public class SubscribeAgInfo extends ApplabServlet {
    ...
    public static String procesReg(String phoneNumber, String message) throws InvalidIdFault, UnexpectedErrorFault, LoginFault,
